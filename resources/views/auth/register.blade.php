            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('register') }}">
                        ...
                        {{-- street address  --}}
                        <div class="form-group row">
                            <label for="street_address" class="col-md-4 col-form-label text-md-right">{{ __('Indirizzo') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cover" type="file" accept=".jpg, .jpeg, .gif, .png, .svg" class="@error('cover') is-invalid @enderror" name="cover" value="{{ old('cover') }}" required autocomplete="cover" autofocus>
