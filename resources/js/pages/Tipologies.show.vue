            ...
            >
                <div class="card card-t rounded-mid overflow-hidden">
                    <div class="overlay overflow-hidden">
                      <img v-if="ristoratore.cover.includes('storage')" :src="`../../../${ristoratore.cover}`" class="card-img-top img-card" alt="" />
                      <img v-else :src="ristoratore.cover" class="card-img-top img-card" alt="">
                    </div>
